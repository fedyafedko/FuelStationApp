        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Robot_Location_CurrentLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedLiters = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FuelRequest_Car_CarId",
                        column: x => x.CarId,
                        principalTable: "Car",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FuelRequest_Location_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Location",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_FuelRequest_Robot_RobotId",
                        column: x => x.RobotId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payment_FuelRequest_FuelRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FuelRequest_CarId",
                table: "FuelRequest",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_FuelRequest_LocationId",
                table: "FuelRequest",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_FuelRequest_RobotId",
                table: "FuelRequest",
                column: "RobotId");

            migrationBuilder.CreateIndex(
                name: "IX_Payment_FuelRequestId",
                table: "Payment",
                column: "FuelRequestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Robot_CurrentLocationId",
                table: "Robot",
